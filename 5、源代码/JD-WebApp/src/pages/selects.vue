<template>
  <div>
    <div class="con">
      <keep-alive>
      <header-input v-for="(i,t) in altShop" :style="{backgroundImage:'url(' + i[0].List[0].backImg + ')', backgroundRepeat:'no-repeat'}"></header-input>
      </keep-alive>
      <keep-alive>
      <shop-list  v-for="(i,t) in altShop" :items="i"></shop-list>
      </keep-alive>
      <keep-alive>
      <shop-datas v-for="(i,t) in altShop" :items="i"></shop-datas>
      </keep-alive>
    </div>
  </div>
</template>
